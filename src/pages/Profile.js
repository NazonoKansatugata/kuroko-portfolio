        ...
        <section className="profile-card">
          ...
          <div className="profile-detail">
            ...
            <ul className="profile-history">
              ...
              <li>興味のある職種: スマホアプリエンジニア, ゲームエンジニア, フロントエンドエンジニア, バックエンド, SE, UI/UXデザイナー, 企画, 事業開発</li>
              <li>勤務地: こだわらない</li>
              <li>企業を選ぶ軸: 安定性, 職場環境・働きやすさ, ワークライフバランス</li>
            </ul>
            <h2>経験・活動</h2>
            <ul className="profile-history">
            ...
            <h2>キャリア目標</h2>
            <p>
              プランナー(企画制作)もできるプログラマーとして、webアプリやネイティブアプリ、ゲーム等幅広く関わっていきたい。
            </p>
            <h2>スキル</h2>
            ...
            <h2>インターン・開発アルバイト</h2>
            <ul className="profile-history">
              <li>株式会社SAKAZUKI（1週間以内）: webデザイン・企画制作・プレゼンテーション</li>
            </ul>
            <h2>活動・受賞歴</h2>
            <ul className="profile-history">
            ...
            <p>
              ...
              今後も「プランナー視点を持ったプログラマー」として、チームの力を最大限に引き出せるエンジニアを目指します。
            </p>
            <h2>関連リンク</h2>
            <ul className="profile-history">
              <li>
